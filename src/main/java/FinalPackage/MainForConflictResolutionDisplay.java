...
public class MainForConflictResolutionDisplay {
    public static void main(String[] args) {
        ...
        retrieveStatementsForSubjectPredicate(mergedModel,"http://dbkwik.webdatacommons.org/marvel.wikia.com/resource/Category:Kevin_McTaggart_(Earth-10005)/Appearances", "http://www.w3.org/2000/01/rdf-schema#label");
        ...
        retrieveStatementsForSubjectPredicate(mergedModel, "http://dbkwik.webdatacommons.org/stexpanded.wikia.com/resource/When_It_Rains...","http://dbkwik.webdatacommons.org/stexpanded.wikia.com/property/originaldate");
